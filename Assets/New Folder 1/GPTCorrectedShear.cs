...
public class GPTCorrectedShear : MonoBehaviour
{
    ...
    void GenerateArrow()
    {
        ...
        // Define triangles for the stem front face (clockwise order)
        triangleList.Add(0);
        triangleList.Add(3);
        triangleList.Add(1);
        ...
        // Define triangles for the stem back face (clockwise order)
        triangleList.Add(4);
        triangleList.Add(6);
        triangleList.Add(5);
        ...
        Vector3 tipOrigin = verticiesList[2];
        ...
        // Define triangles for the arrowhead front face (clockwise order)
        triangleList.Add(10);
        triangleList.Add(8);
        triangleList.Add(9);

        // Define triangles for the arrowhead back face (clockwise order)
        triangleList.Add(11);
        triangleList.Add(13);
        triangleList.Add(12);
