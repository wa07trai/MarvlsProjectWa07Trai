     ...
     triangleList.Add(0);
      triangleList.Add(3);
       ...
       triangleList.Add(7);
        ...
        verticiesList.Add(tipOrigin + (tipHalfWidth * Vector3.up) + (stemLength * Vector3.right) + (stemHalfWidth * Vector3.up) - stemWidth * Vector3.forward);
        verticiesList.Add(tipOrigin + (tipHalfWidth * Vector3.down) + (stemLength * Vector3.right)+(stemHalfWidth * Vector3.up) - stemWidth * Vector3.forward);
        verticiesList.Add(tipOrigin + (tipLength * Vector3.right) + (stemLength * Vector3.right)+(stemHalfWidth * Vector3.up) - stemWidth * Vector3.forward);

        // Vertices for the arrowhead back face (offset by tipWidth)
        verticiesList.Add(verticiesList[8] +  stemWidth * Vector3.forward);//- (tipWidth * Vector3.forward));
        verticiesList.Add(verticiesList[9] +  stemWidth * Vector3.forward);//- (tipWidth *Vector3.forward));
        verticiesList.Add(verticiesList[10] +  stemWidth * Vector3.forward);// - (tipWidth *Vector3.forward));
